...
def train_cifar(learning_rate_base=10,batch_size=128,n_epochs=20,test_frequency=1300, check_point_frequency=5000,show_progress_frequency=100):
    ...
    train_set_x, train_set_y = load_cifar_data(['data_batch_1','data_batch_2','data_batch_3','data_batch_4','data_batch_5'],UNIT_STD=1)
    test_set_x, test_set_y = load_cifar_data(['test_batch'],WHICHSET='test',UNIT_STD=1)
    ...
    if options.filename == 'None':
        ...
        conv_pool2 = LeNetConvPoolLayer(rng=rng2,input=conv_pool1.output,
                                        ...
                                        activation='relu',
                                        poolsize=(3,3),poolstride=2,pad=2,
                                        convstride=1,initW=0.05,initB=0,partial_sum=4,
                                        pooling='average',
                                        epsW=0.001,
                                        epsB=0.002,
                                        momW=0.9,
